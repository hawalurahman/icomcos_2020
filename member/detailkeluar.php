...
//	if ($_GET[act]=='pm'){
		 $tam =mysqli_fetch_array(mysqli_query($dbconnect,"SELECT a.idpesan,a.penerima,b.nmdepan,b.nmakhir,a.isi,a.tglpesan,a.jampesan,a.buka,a.subyek,a.file1,a.file2 FROM pesanmasuk a left join user b on b.iduser=a.penerima WHERE a.idpesan=$_GET[id]"));
		 $tgl=$tam[tglpesan];
		 if (!empty($tam[file1])){
		 ...
		 echo  "<table bgcolor='#6699ff' width='770'>";
		 echo  "<tr><td colspan=3  bgcolor='white' align='center'><font color='red' size=3><b>OUT-BOX MESSAGE</b></font></td></tr>";
		 echo  "<tr><td bgcolor='#6699ff' width='140' style='padding-left:10px;'><font color='red'><b>To</b></font></td><td style='padding:0px;'> : </td><td bgcolor='#6699ff' style='padding-left:10px;'><font color='brown'><b>$tam[nmdepan] $tam[nmakhir]</b></font></td></tr>";
		 ...
		 $attact1 
		 $attact2 </td></tr>";
		 echo  "<tr><td colspan=3 align='center'><input class='button' type=button value=Back onclick=javascript:Request('lihatkeluar.php','','formpesan')></td></tr>";
		 echo  "</table>";
//	 	 mysqli_query($dbconnect,"UPDATE pesanmasuk SET buka=1 where idpesan=$_GET[id]");
//	}
