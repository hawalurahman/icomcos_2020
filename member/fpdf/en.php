...
$que=mysql_query("select *, date_format(tanggal, '%d-%m-%Y') as tanggal from warta_e where row_id=$news");
...
$title=$dta[judul];
$pdf->SetTitle($title);
$pdf->SetAuthor($dta[penulis]);
$pdf->SetLeftMargin(45);
//$pdf->Image('../../photo/'.$dta[photo],10,10,30,0,'','http://www.fpdf.org');
$pdf->PrintChapter(1,$dta[tanggal],$dta[isi]);
